...
|---|---|---|---|---|
| `robot_name` | string | **Mandatory** | none — must be provided | Name of the robot model; selects the kinematic model file from the package `robots/` directory (e.g. `r820` → `robots/r820.json`) |
